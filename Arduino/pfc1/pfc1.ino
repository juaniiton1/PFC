...
int u = 255;
int colors[] = { 0,0,0, 0,0,u, 0,u,0, 0,u,u,
                 u,0,0, u,0,u, u,u,0, u,u,u };
	     ...
	     data = wifi.read();
             ...
             if (code == 0) {
               if (data < 4) {
                 ...
                 shift.sendColor(red, green, blue);
                 red = green = blue = 0;
               } else {
...
// Con todo el rgb en el data (pero no cabe mas que 256)
//             int red = (rgb >> 16) & 0xFF;
...
//           shift.sendColor(colors[index], colors[index+1], colors[index+2]);
	  }
  }
